...
if(isset($_POST['accept'])) {
  ...
  include "C:/xampp/htdocs/lcr/accountSettings/$userInviter/rooms/$inviteCode.php";
  ...
  if(array_key_exists($inviteCode, $rooms)=="TRUE") {
    ...
    listToFile($peopleInRoom, $userName, "C:/xampp/htdocs/lcr/accountSettings/$userInviter/rooms/$inviteCode.php", "peopleInRoom");
    takeArrayFromFile($userInvites, $inviteCode, "C:/xampp/htdocs/lcr/accountSettings/$userName/invites.php", "userInvites");
...
if(isset($_POST['deleteRoom'])) {
  $key = $_POST['key'];
  include "C:/xampp/htdocs/lcr/accountSettings/$userName/rooms/$key.php";
  include "C:/xampp/htdocs/lcr/accountSettings/$userName/ownedRooms.php";
  // Remove room files from rooms folder and global database and the user's owned rooms database.
  deletedir("C:/xampp/htdocs/lcr/Rooms/$key");
  takeArrayFromFile($rooms, $key, "C:/xampp/htdocs/lcr/rooms.php", "rooms");
  takeArrayFromFile($ownedRooms, $key, "C:/xampp/htdocs/lcr/accountSettings/$userName/ownedRooms.php", "ownedRooms");
  // Find all users in room and take the room from their personal database
  foreach($peopleInRoom as $user) {
    include "C:/xampp/htdocs/lcr/accountSettings/$user/roomDatabase.php";
    takeArrayFromFile($registeredRooms, $key, "C:/xampp/htdocs/lcr/accountSettings/$user/roomDatabase.php", "registeredRooms");
  }
  // Delete the file that contains who is in the room you deleted
  unlink("C:/xampp/htdocs/lcr/accountSettings/$userName/rooms/$key.php");
}
...
if(isset($_POST['inviteUser'])) {
  ...
  include "C:/xampp/htdocs/lcr/accountSettings/$inviteeName/invites.php";
  arrayToFile($userInvites, $userCode, $userName, "C:/xampp/htdocs/lcr/accountSettings/$inviteeName/invites.php", "userInvites");
}
?>
<html>
  <head>
  ...
  <body>
    ...
    <div class="mainContent" style="padding-left:25%;">
      ...
      <table style="width:100%;">
        ...
        include "C:/xampp/htdocs/lcr/$userName/ownedRooms.php";

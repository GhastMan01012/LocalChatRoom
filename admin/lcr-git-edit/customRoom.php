...
<html>
  ...
  <body>
    <?php include 'headerbar.php'; include 'sidebar.php'; include "C:/xampp/htdocs/accountSettings/$userName/roomDatabase.php"; include 'rooms.php'; include "C:/xampp/htdocs/accountSettings/$userName/ownedRooms.php"; ?>
    <h2>Create A Room</h2>
    <div>
      ...
      if(isset($_POST['roomName'])) {
        ...
        arrayToFile($registeredRooms, $roomCode, $roomName, "C:/xampp/htdocs/accountSettings/$userName/roomDatabase.php", "registeredRooms");
        ...
        arrayToFile($ownedRooms, $roomCode, $roomName, "C:/xampp/htdocs/accountSettings/$userName/ownedRooms.php", "ownedRooms");
        // Create a new database to contain the names of users that have been added to the users.
        $peopleInRoomFile = fopen("C:/xampp/htdocs/accountSettings/$userName/rooms/$roomCode.php", "c+");
        fwrite($peopleInRoomFile, '<?php $peopleInRoom = array(); ?>');
        fclose($peopleInRoomFile);
        // Add themselves to the database
        include "C:/xampp/htdocs/accountSettings/$userName/rooms/$roomCode.php";
        listToFile($peopleInRoom, $userName, "C:/xampp/htdocs/accountSettings/$userName/rooms/$roomCode.php", "peopleInRoom");
      }
      ?>
    </div>
  </body>

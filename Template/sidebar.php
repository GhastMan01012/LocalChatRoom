...
if($userName != "") {
  include "/Users/ethan/Sites/chat/accountSettings/$userName/roomDatabase.php";
}
$currentdir = str_replace("/Users/ethan/Sites", "", getcwd());
$pageCode = str_replace('/chat/Rooms/', "", $currentdir);
$userPermFile = fopen("/Users/ethan/Sites/chat/accountSettings/$userName/perms.txt", "r+");
$userPerm = fread($userPermFile, filesize("/Users/ethan/Sites/chat/accountSettings/$userName/perms.txt"));
fclose($userPermFile);
?>

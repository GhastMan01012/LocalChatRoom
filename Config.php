...
if(isset($_POST['accept'])) {
  ...
  include "/Users/ethan/Sites/chat/accountSettings/$userInviter/rooms/$inviteCode.php";
  ...
  if(array_key_exists($inviteCode, $rooms)=="TRUE") {
    ...
    listToFile($peopleInRoom, $userName, "/Users/ethan/Sites/chat/accountSettings/$userInviter/rooms/$inviteCode.php", "peopleInRoom");
    takeArrayFromFile($userInvites, $inviteCode, "/Users/ethan/Sites/chat/accountSettings/$userName/invites.php", "userInvites");
...
if(isset($_POST['deleteRoom'])) {
  $key = $_POST['key'];
  include "/Users/ethan/Sites/chat/accountSettings/$userName/rooms/$key.php";
  include "/Users/ethan/Sites/chat/accountSettings/$userName/ownedRooms.php";
  // Remove room files from rooms folder and global database and the user's owned rooms database.
  deletedir("/Users/ethan/Sites/chat/Rooms/$key");
  takeArrayFromFile($rooms, $key, "/Users/ethan/Sites/chat/rooms.php", "rooms");
  takeArrayFromFile($ownedRooms, $key, "/Users/ethan/Sites/chat/accountSettings/$userName/ownedRooms.php", "ownedRooms");
  // Find all users in room and take the room from their personal database
  foreach($peopleInRoom as $user) {
    include "/Users/ethan/Sites/chat/accountSettings/$user/roomDatabase.php";
    takeArrayFromFile($registeredRooms, $key, "/Users/ethan/Sites/chat/accountSettings/$user/roomDatabase.php", "registeredRooms");
  }
  // Delete the file that contains who is in the room you deleted
  unlink("/Users/ethan/Sites/chat/accountSettings/$userName/rooms/$key.php");
}
...
if(isset($_POST['inviteUser'])) {
  ...
  include "/Users/ethan/Sites/chat/accountSettings/$inviteeName/invites.php";
  arrayToFile($userInvites, $userCode, $userName, "/Users/ethan/Sites/chat/accountSettings/$inviteeName/invites.php", "userInvites");
}
?>
<html>
  <head>
